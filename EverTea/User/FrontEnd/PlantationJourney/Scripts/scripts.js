...
export const useAppLogic = () => {
  ...
  const plantationAreaAndSlope = async () => {
    try {
      const response = await axios.post('http://192.168.1.3:8080/api/user/plantationAreaAndSlope', {
  ...
  const budgetAndTheTeaPlantsOfTheUser = async () => {
    try {
      const response = await axios.post('http://192.168.1.3:8080/api/user/budgetAndTheTeaPlantsOfTheUser', {
  ...
  const budgetRecommendation = async () => {
    try {
      const response = await axios.post('http://192.168.1.3:8080/api/user/budgetRecommendation', {
      });
  ...
  const plantationCreation = () => {
    try {
      const response = axios.post('http://192.168.1.3:8080/api/user/plantationCreation', {
      });
