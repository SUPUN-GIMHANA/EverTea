...
const navigation = useNavigation<StackNavigationProp<RootStackParamList, 'Flow2'>>();  // Type the navigation
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Plan your plantation with{'\n'} step-by-step guidance based{'\n'} on
        your budget.
      </Text>
      ...
      <View style={styles.buttomContainer}>
        ...
        <View style={styles.RightButton}>
          <TouchableOpacity onPress={() => navigation.navigate('Flow3')}>
